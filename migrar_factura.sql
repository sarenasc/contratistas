-- =====================================================
-- Migración: reemplaza dota_factura con nueva estructura
-- (agrega version, mueve id_contratista al detalle)
-- Ejecutar solo si ya existe la tabla vieja.
-- =====================================================

/* 1. Borrar detalle si existe (tiene FK a cabecera) */
IF OBJECT_ID('dbo.dota_factura_detalle','U') IS NOT NULL
    DROP TABLE dbo.dota_factura_detalle;
GO

/* 2. Borrar cabecera vieja */
IF OBJECT_ID('dbo.dota_factura','U') IS NOT NULL
    DROP TABLE dbo.dota_factura;
GO

/* 3. Crear cabecera nueva */
